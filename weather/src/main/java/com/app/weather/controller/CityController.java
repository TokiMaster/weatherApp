...
public class CityController {
    ...
    @GetMapping("avg")
    public List<AverageTemperatureInfoDTO> averageTemperatureInfo(@RequestParam(value = "name", required = false) String name,
                                             @RequestParam(value = "days") Integer days) {
        return cityService.averageTemperatureInfo(name, days);
    }
